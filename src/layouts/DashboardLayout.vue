                ...
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <img class="h-6" src="https://static.wixstatic.com/media/45c679_01b59670c7fb49afa8fc0b335c65246f~mv2.png/v1/crop/x_0,y_286,w_1384,h_246/fill/w_209,h_37,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/newcortex%20logo.png" alt="Your Company" />
                        </div>
                                ...
                                <transition enter-active-class="transition ease-out duration-100" enter-from-class="transform opacity-0 scale-95" enter-to-class="transform opacity-100 scale-100" leave-active-class="transition ease-in duration-75" leave-from-class="transform opacity-100 scale-100" leave-to-class="transform opacity-0 scale-95">
                                    <MenuItems class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                        <MenuItem v-for="item in userNavigation" :key="item.name" v-slot="{ active }">
                                            <span class="cursor-pointer" @click="UserNavAction(item)" :class="[active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700']">{{ item.name }}</span>
                                        </MenuItem>
                                    </MenuItems>
                                </transition>
                            </Menu>
